...
тысяч знаков технической прозы, находит около пяти замечаний каждый раз.** Условие приёмки «критик
молчит» для такого жанра почти недостижимо, сколько раундов ни купи, и закрыли бы вопрос не
раунды, а две вещи, которых в движке пока нет: детектор полки (остановиться, когда счёт перестал
падать) и отчёт о незакрытом (отдать документ с поимённо названными открытыми пунктами — это и
был задуманный исход для замечаний, которые раунд закрыть не может).
...
запись описания, поиск источников в сети, остановки на выверку, веб-интерфейс. Проверки: 661
