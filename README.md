...
![Граф конвейера: обход папки, извлечение по документу на агента, петля писатель и критик с остановкой на выверку, проектирование на двух моделях, выбор победителя; на связях указаны типы артефактов](assets/dsl-graph.png)
